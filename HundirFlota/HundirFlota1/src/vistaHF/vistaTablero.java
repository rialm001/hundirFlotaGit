...
public class vistaTablero extends JFrame implements Observer {
	...
	private void centrarPantalla()
	{
		...
		Dimension frameSize = getSize(); //Tama駉 del frame actual (ancho x alto)
	...
	{ //par醡etros de entrada 
		...
		JButton btn = new JButton(); //texto del bot髇
	...
	private Controlador4 getControladorCasilla() {
		...
		return controladorCasilla;
			...
			private class Controlador implements ActionListener {
				//Tras pulsar el bot贸n, abre una nueva pantalla
			...
			public void update(Observable o, Object arg) {
				// TODO Esbozo de m閠odo generado autom醫icamente
